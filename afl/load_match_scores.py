...
Usage::
    ...
    python -m afl.load_match_scores --source data/afl/raw/matches/afltables_bg3.txt
    python -m afl.load_match_scores --source ... --audit-only
"""
...
def _upsert_club_observations(con: sqlite3.Connection, row: SourceMatch,
    ...
    if not con.execute(
        ...
        return
    from utils.club_sources import ALL_GAMES_BY_ID
