"""
grid_fixtures.py -- Real Gridley grids, kept as permanent regression
fixtures.

The grids themselves now live in historic_grids.py, as HistoricGrid
...
there is never substituted: see the module docstring in historic_grids.py
