...
"""Build the Club Explorer tables from a sport's own database.
    ...
    python utils/derive_club_tables.py --sport nba
    python utils/derive_club_tables.py --sport all --report

The AFL's club layer is scraped: utils/fetch_club_sources.py pulls
AFLTables and Wikipedia, and utils/load_club_sources.py parses them. No
