...
pages = {
    ...
    "Explore": [
        ...
        st.Page("app_pages/8_Advanced_Search.py", title="Advanced Search", icon=":material/manage_search:"),
    ...
    "Play": [
        st.Page("app_pages/11_Grid_Solver.py", title="Grid Solver", icon=":material/grid_on:"),
        st.Page("app_pages/12_Game_Lab.py", title="Game Lab", icon=":material/science:"),
    ],
    "Account & Settings": [
        st.Page("app_pages/2_Account.py", title="Account", icon=":material/account_circle:"),
        st.Page("app_pages/13_Database_Health.py", title="Database Health", icon=":material/health_and_safety:"),
    ]
}

if SPORT.has_ground_explorer:
    pages["Explore"].insert(4, st.Page("app_pages/5_Ground_Explorer.py", title="Ground Explorer", icon=":material/stadium:"))
