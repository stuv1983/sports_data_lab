#!/usr/bin/env python3
"""
utils/nba/load_nba_playoff_series.py -- Normalise the saved playoff-series extract
into data/nba/reference/playoff_series.csv.

    python -m utils.nba.load_nba_playoff_series
    python -m utils.nba.load_nba_playoff_series --check
...
def write(rows, out_path, extract_path, verbose=True):
    ...
    meta.write_text(json.dumps({
        "generated_by": "utils/nba/load_nba_playoff_series.py",
