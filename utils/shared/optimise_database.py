...
# Run standalone from anywhere: the project root is two levels up.
import sys as _sys
...
INDEXES = [
    ...
    ("idx_sdl_games_club_hist_player", "games",
     ("club_hist", "player_id"), None),
    ("idx_sdl_games_debut_club_player", "games",
     ("career_game_no", "club_now", "player_id"), None),
    ("idx_sdl_games_debut_club_hist_player", "games",
     ("career_game_no", "club_hist", "player_id"), None),
    ("idx_sdl_games_teammate", "games",
     ("club_hist", "season", "date", "opponent", "player_id"), None),
    ...
    ("idx_sdl_games_round_player", "games", ("round", "player_id"), None),
