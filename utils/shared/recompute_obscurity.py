...
authoritative scorer, and writes the column back.
    ...
    python -m utils.shared.recompute_obscurity                 # AFL database
    python -m utils.shared.recompute_obscurity --dry-run
    python -m utils.shared.recompute_obscurity --sport nba
    python -m utils.shared.recompute_obscurity --db other.db
