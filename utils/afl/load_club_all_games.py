...
Usage:
    ...
    python -m utils.afl.load_club_all_games --club richmond --details
    python -m utils.afl.load_club_all_games --apply-only  # after a rebuild
    python -m utils.afl.load_club_all_games --dry-run
"""
...
from utils.afl.club_all_games import (MatchObservation, check_against_footers,
