...
Examples:
    python -m utils.afl.load_family_relationships --inspect
    python -m utils.afl.load_family_relationships --db gridley.db
    python -m utils.afl.load_family_relationships --db gridley.db --report --details
"""
