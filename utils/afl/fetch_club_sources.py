...
HTML through ``utils/afl/load_club_sources.py``.

Examples from the project root:
    python -m utils.afl.fetch_club_sources --report
    python -m utils.afl.fetch_club_sources --club adelaide --refresh
    python -m utils.afl.fetch_club_sources --open-afltables
    python -m utils.afl.fetch_club_sources --afltables-permission-confirmed
"""
